...
### Alterado
- Confirmação da importação: bloco da fatura anterior mais compacto, com os pontos conferidos em linha e ícone de check ou alerta em cada um, no lugar dos sinais em texto. E o bloco "esta fatura já está paga" ganha **Corrigir a data ou desfazer o pagamento**: marcando, a pergunta de pagamento volta, permitindo trocar a data ou marcar a fatura como em aberto.
