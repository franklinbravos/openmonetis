...
### Corrigido
- Conferência da fatura: pagamento adiantado deixa de aparecer como **erro em vermelho**. O banco declara no arquivo o *saldo* da fatura, já líquido do que foi pago no ciclo, enquanto os lançamentos são as cobranças brutas — em junho, R$ 7.978,14 contra R$ 10.478,14. A conferência tratava os R$ 2.500,00 de diferença como divergência a corrigir, quando é o pagamento de 18/05 que o banco já havia abatido. Agora ela desconta os pagamentos registrados, fecha em R$ 0,00 e explica de onde vem a diferença entre os dois totais. A linha "Cobrado pelo banco no arquivo" some nesse caso: o número não é o cobrado, é o saldo.
