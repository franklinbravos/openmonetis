...
- Confirmação da importação: ajuste da fatura anterior e atualização de limites passam a contar como trabalho a confirmar. Reprocessar uma fatura já conferida e paga não mexe em lançamento nenhum, mas pode corrigir esses dois — e o botão de confirmar ficava desabilitado com trabalho pendente na tela.
